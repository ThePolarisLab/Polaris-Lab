...
MOTIVE_EXPECTED_COLUMNS: dict[str, set[str]] = {
    ...
    "motive_vehicle_utilization": {"id", "organization_id", "organization_slug", "provider", "provider_vehicle_id", "motive_vehicle_id", "source_endpoint", "request_window_start", "request_window_end", "reporting_period_start", "reporting_period_end", "utilization_percent", "idle_time", "driving_time", "idle_fuel", "driving_fuel", "metric_units", "distance", "engine_hours", "observed_at", "parser_version", "provider_payload_metadata", "created_at", "updated_at"},
    ...
    "motive_vehicle_utilization_kpi_snapshots": {"id", "organization_id", "organization_slug", "kpi", "kpi_version", "status", "window_start", "window_end", "request_timezone", "value_percent", "selected_vehicle_count", "expected_requested_vehicle_days", "provider_rollup_vehicle_days", "metric_valid_vehicle_days", "missing_requested_vehicle_days", "provider_rollup_coverage_percent", "utilization_metric_coverage_percent", "fleet_representative", "fuel_unit", "unit_request_mode", "source_history_id", "computed_at", "created_at", "updated_at"},
}
