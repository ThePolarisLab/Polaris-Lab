...
const athenaCompatibilityEvidence = [
  "tests/certification/athenaCompatibilityCertification.test.ts",
  "docs/hermes/HERMES_ATHENA_COMPATIBILITY_CERTIFICATION.md",
...
export const hermesCertificationManifest: CertificationCriterion[] = [
  ...
  { id: "HCF-009", domain: "athena-compatibility", title: "Athena consumes Hermes outputs only through governed contracts", owner: "Athena", severity: "critical", evidenceRequired: athenaCompatibilityEvidence, status: "passed" },
