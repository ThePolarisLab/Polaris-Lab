...
export const hermesCertificationManifest: CertificationCriterion[] = [
  ...
  { id: "HCF-007", domain: "resilience", title: "Partial failure and restart recover from durable checkpoints", owner: "Hermes", severity: "high", evidenceRequired: ["failure-injection test", "checkpoint recovery assertion"], status: "planned" },
  { id: "HCF-008", domain: "security", title: "Secrets remain outside evidence, logs, and domain state", owner: "Security", severity: "critical", evidenceRequired: ["secret-boundary review", "negative serialization test"], status: "planned" },
  ...
  { id: "HCF-010", domain: "operations", title: "Health and failure signals are observable without exposing secrets", owner: "Mission Control", severity: "high", evidenceRequired: ["health contract test", "operational evidence sample"], status: "planned" },
];
